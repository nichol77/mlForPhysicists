...
# This notebook was taken almost in its entirity from the lecture series "Machine Learning for Physicists" by Florian Marquardt. See https://machine-learning-for-physicists.org.
#
...
# # Suggested task 1: train on differently shaped samples (e.g. a bar with both random position and random width)
#
